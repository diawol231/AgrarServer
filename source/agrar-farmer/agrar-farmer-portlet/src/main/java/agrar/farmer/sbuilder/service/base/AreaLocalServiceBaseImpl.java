...
import agrar.farmer.sbuilder.service.AreaLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link agrar.farmer.sbuilder.service.impl.AreaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see agrar.farmer.sbuilder.service.impl.AreaLocalServiceImpl
 * @see agrar.farmer.sbuilder.service.AreaLocalServiceUtil
 * @generated
 */
public abstract class AreaLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements AreaLocalService, IdentifiableBean {
    @BeanReference(type = agrar.farmer.sbuilder.service.AreaLocalService.class)
    protected agrar.farmer.sbuilder.service.AreaLocalService areaLocalService;
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link agrar.farmer.sbuilder.service.AreaLocalServiceUtil} to access the area local service.
     */
     ...
     */
    @Override
    public Area createArea(long id) {
        return areaPersistence.create(id);
    }
    ...
    @Override
    public Area deleteArea(long id) throws PortalException, SystemException {
        return areaPersistence.remove(id);
    }
    ...
    @Override
    public Area fetchArea(long id) throws SystemException {
        return areaPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Area getArea(long id) throws PortalException, SystemException {
        return areaPersistence.findByPrimaryKey(id);
    }
     ...
     */
    public agrar.farmer.sbuilder.service.AreaLocalService getAreaLocalService() {
    ...
    public void setAreaLocalService(
        agrar.farmer.sbuilder.service.AreaLocalService areaLocalService) {
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("agrar.farmer.sbuilder.model.Area",
            areaLocalService);
    }
