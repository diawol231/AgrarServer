 ...
 * @generated
 */
public class FarmerAreaLocalServiceClp implements FarmerAreaLocalService {
    ...
    public FarmerAreaLocalServiceClp(
    ...
    public agrar.farmer.sbuilder.model.FarmerArea addFarmerArea(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(farmerArea) });
        } catch (Throwable t) {
        ...
        return (agrar.farmer.sbuilder.model.FarmerArea) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<agrar.farmer.sbuilder.model.FarmerArea> getFarmerAreas(
        ...
        return (java.util.List<agrar.farmer.sbuilder.model.FarmerArea>) ClpSerializer.translateOutput(returnObj);
    }
