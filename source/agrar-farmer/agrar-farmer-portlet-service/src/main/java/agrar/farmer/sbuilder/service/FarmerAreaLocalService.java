...
/**
 * Provides the local service interface for FarmerArea. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FarmerAreaLocalServiceUtil
...
public interface FarmerAreaLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link FarmerAreaLocalServiceUtil} to access the farmer area local service. Add custom service methods to {@link agrar.farmer.sbuilder.service.impl.FarmerAreaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
