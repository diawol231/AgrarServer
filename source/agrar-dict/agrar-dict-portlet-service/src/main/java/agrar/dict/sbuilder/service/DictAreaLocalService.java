...
/**
 * Provides the local service interface for DictArea. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DictAreaLocalServiceUtil
...
public interface DictAreaLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link DictAreaLocalServiceUtil} to access the dict area local service. Add custom service methods to {@link agrar.dict.sbuilder.service.impl.DictAreaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
